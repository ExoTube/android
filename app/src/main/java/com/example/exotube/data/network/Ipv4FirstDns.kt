 ...
 *
 * YouTube ata cada dirección de video a la IP que la pidió, y yt-dlp y NewPipe la piden siempre
 * por IPv4 (ver `YtDlpCatalog.directUrls` y [StreamHttpClient]). Si el reproductor la descargara por IPv6 —lo que Android
